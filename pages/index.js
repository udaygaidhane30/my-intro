      ...
      <Flex mb="4rem" justify="space-between">
        ...
        >
          <Heading mb="0.5rem" as="h1" variant="h1">
            Hi, I’m Uday Gaidhane.
          </Heading>
          <Text mb={{ base: '4rem', lg: '6rem' }} as="h2" variant="subtitle">
            This is my slice of the internet, where I showcase my ideas, share
            my favorite thoughts, and indulge in all sorts of randomness.
          </Text>
          <Heading as="h3" variant="h3" mb="0.5rem">
            Alright, but who exactly are you?
          </Heading>
          <Text fontSize="xl" mb="2rem">
            I'm a developer fueled by curiosity and focused on tech, crafting
            rich, user-centered, and inclusive experiences for the web.
          </Text>
